...
class Animal { //plantilla del/los objtos 
         ...
         verInfor() {         // Metodos es como una funcion del objeto 
                  console.log(`Esto es un metodo que muestra la informacion: ${this.informacion}`)
         }
}
...
class Aves {
         ...
         presentacionFormal() {
                  console.log(`Soy un ${this.nombre}, de tamaño ${this.tamano}, de color ${this.color}. Mi hábitat principal es ${this.habitat}.`);
         }
}

const aguila = new Aves("Águila Real", "rapaz", "grande", "marrón y blanco", "montañas");
const colibri = new Aves("Colibrí ", "colibrí", "pequeño", "vibrante", "jardines");
const pinguino = new Aves("Pingüino ", "pingüino", "mediano", "negro y blanco", "regiones polares");
const cuervo = new Aves("Cuervo", "cuervo", "mediano", "negro", "bosques y ciudades");
const tucan = new Aves("Tucán", "tucán", "grande", "multicolor", "selvas tropicales");
const albatros = new Aves("Albatros", "albatros", "grande", "blanco", "océanos abiertos");
...
class AvesAcuaticas extends Aves {
         constructor(nombre, tipo, tamano, color, habitat, tipoDeAgua, paisResidencia) {
                  ...
                  console.log (`• Este es un metodo estatico • es un metodo de clase, no puede utilzar this`);
                  }
         }

const pato = new AvesAcuaticas("Pato", "acuática", "mediano", "blanco y marrón", "lagunas", "dulce" ,"Argentina");
pato.nadar()
